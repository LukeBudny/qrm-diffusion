...
EXPERIMENTS = [
    ...
    #                 dict(
    #     model_tag    = "transformer_10ep_rf_loss_lr5e-6_add_qt_one_step_train",
    ...
    # ),
    #             dict(
    #     model_tag    = "transformer_10ep_rf_loss_lr1e-5_add_qt_one_step_train",
    #     qrm_type     = "transformer",
    #     lr           = 1e-5,       
    #     num_epochs   = 5,
    #     eval_model   = 'clip',
    ...
    # ),
    #                 dict(
    #     model_tag    = "transformer_10ep_rf_loss_lr1e-4_add_qt_one_step_train_nocond",
    #     qrm_type     = "transformer",
    #     lr           = 1e-4,       
    #     num_epochs   = 5,
    #     eval_model   = 'clip',
    ...
    # ),
    # dict(
    #     model_tag    = "transformer_10ep_rf_loss_lr1e-4_add_qt_sched",
    #     qrm_type     = "transformer",
    #     lr           = 1e-4,       
    #     num_epochs   = 5,
    #     eval_model   = 'clip',
    ...
    #     dict(
    #     model_tag    = "transformer_5ep_rf_loss_lr5e-6_add_qt_clip_weight_0p25",
    #     qrm_type     = "transformer",
    #     lr           = 5e-6,       
    #     num_epochs   = 5,
    #     eval_model   = 'clip',
    ...
    # ),
    dict(
        model_tag    = "transformer_5ep_rf_loss_lr5e-6_add_qt_image_reward_weight_0p50_one_step_no_q_weight",
        qrm_type     = "transformer",
        lr           = 5e-6,       
        num_epochs   = 100,
        eval_model   = 'ir',
    ...
    dict(
        model_tag    = "transformer_5ep_rf_loss_lr5e-6_add_qt_clip_weight_0p50_one_step_no_q_weight",
        qrm_type     = "transformer",
        lr           = 5e-6,       
        num_epochs   = 100,
        eval_model   = 'clip',
    ...
    #     dict(
    #     model_tag    = "transformer_5ep_rf_loss_lr5e-6_add_qt_hps_weight_0p50_one_step_no_q_weight",
    #     qrm_type     = "transformer",
    #     lr           = 5e-6,       
    #     num_epochs   = 100,
    #     eval_model   = 'hps',
...
for exp_id, exp in enumerate(EXPERIMENTS, start=1):
    ...
    trainer.train(
        ...
        ir_weight   = exp.get("ir_weight", COMMON["ir_weight"]),
        hps_weight   = exp.get("hps_weight", COMMON["hps_weight"]),
