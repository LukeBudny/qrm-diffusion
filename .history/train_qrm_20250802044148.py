...
EXPERIMENTS = [
    ...
    # REMEMBER TO CHECK THE LOSSES FOR THE BELOW
        dict(
        model_tag    = "transformer_10ep_rf_loss_lr5e-6_add_qt_clip_weight_0p25",
        qrm_type     = "transformer",
        lr           = 5e-6,       
        num_epochs   = 5,
        eval_model   = 'clip',
    ...
    dict(
        model_tag    = "transformer_10ep_rf_loss_lr5e-6_add_qt_clip_weight_0p50",
        qrm_type     = "transformer",
        lr           = 5e-6,       
        num_epochs   = 5,
        eval_model   = 'clip',
        ...
        dict(
        model_tag    = "transformer_10ep_rf_loss_lr5e-6_add_qt_clip_weight_1",
        qrm_type     = "transformer",
        lr           = 5e-6,       
        num_epochs   = 5,
        eval_model   = 'clip',
