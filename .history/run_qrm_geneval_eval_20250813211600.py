...
# "20250813_073058_transformer_rf_loss_lr5e-6_add_qt_image_reward_weight_0p50_one_step_no_q_weight_sched_e10": "models/20250813_073058_transformer_rf_loss_lr5e-6_add_qt_image_reward_weight_0p50_one_step_no_q_weight_sched/qrmmlp_joint_epoch_10.pth",
...
required_cols = ["clip_score", "image_reward"]
...
full_summary = pd.concat(
    [
        overall_accuracy,
        mean_clip_geneval, mean_reward_geneval,mean_hpsv2_geneval,
        mean_clip_coco, mean_reward_coco,mean_hpsv2_coco,
        task_summary
    ],
    axis=1
).reset_index().round(4)
