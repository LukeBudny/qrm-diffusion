        ...
        for metadata_batch in chunked(metadata_list, BATCH_SIZE):
            ...
            if qrm_ckpt is not None:
                ...
                latents_batch = torch.cat([
                    inferencer.get_empty_latent(1, 1024, 1024, SEED + i).cuda().half()
                ...
                for step_idx in range(len(sigmas) - 1):
                    ...
                    for img_idx in range(len(prompts_batch)):
                        ...
                        latents_batch[img_idx:img_idx+1], old_denoised_list[img_idx] = inferencer.run_single_dpmpp_step(
                            inferencer.get_denoiser(),
                    ...
                    for img_idx in range(len(prompts_batch)):
                        ...
                        final_latent = inferencer.SD3LatentFormat().process_out(latents_batch[img_idx:img_idx+1])
