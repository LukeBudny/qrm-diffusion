...
EXPERIMENTS = [
    ...
    # ),
    dict(
        model_tag    = "transformer_rf_loss_lr5e-6_add_qt_image_reward_weight_0p50_one_step_no_q_weight",
        qrm_type     = "transformer",
        lr           = 5e-6,       
        num_epochs   = 100,
        eval_model   = 'ir',
    ...
    dict(
        model_tag    = "transformer_rf_loss_lr5e-6_add_qt_0p50_one_step_no_q_weight",
        qrm_type     = "transformer",
        lr           = 5e-6,       
        num_epochs   = 100,
        eval_model   = 'clip',
        ...
        dict(
        model_tag    = "transformer_rf_loss_lr5e-6_add_qt_clip_weight_0p50_one_step_no_q_weight",
        qrm_type     = "transformer",
        lr           = 5e-6,       
        num_epochs   = 100,
        eval_model   = 'clip',
