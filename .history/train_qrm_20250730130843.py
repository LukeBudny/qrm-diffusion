...
EXPERIMENTS = [
    ...
    #     dict(
    #     model_tag    = "transformer_10ep_rf_loss_lr1e-5_add_qt_clip_weight_0p25",
    #     qrm_type     = "transformer",
    #     lr           = 1e-4,       
    #     num_epochs   = 3,
    #     eval_model   = 'clip',
    ...
    # ),
    # dict(
    #     model_tag    = "transformer_10ep_rf_loss_lr1e-5_add_qt_clip_weight_0p50",
    #     qrm_type     = "transformer",
    #     lr           = 1e-4,       
    #     num_epochs   = 5,
    #     eval_model   = 'clip',
    ...
    # ),
    #     dict(
    #     model_tag    = "transformer_10ep_rf_loss_lr1e-4_add_qt_clip_weight_1",
    #     qrm_type     = "transformer",
    #     lr           = 1e-4,       
    #     num_epochs   = 5,
    #     eval_model   = 'clip',
