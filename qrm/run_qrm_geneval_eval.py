...
geneval_output_dir = "geneval/comparative_initial_images" if LIGHTWEIGHT else "geneval/comparative_images"
valcoco2014_output_dir = "coco_val_images/comparative_initial_images" if LIGHTWEIGHT else "coco_val_images/comparative_images"
results_dir = "comparative_initial_results" if LIGHTWEIGHT else "comparative_results"
summary_json = "comparative_initial_results/qrm_eval_summary.json" if LIGHTWEIGHT else "comparative_results/qrm_eval_summary.json"
...
gen_cmd = [
    ...
    "--num_prompts", "-1",
    "--num_variants", "1",            # baseline default
    "--seed", "42",
]
if LIGHTWEIGHT:
...
cmd = [
    ...
    "--num_variants", str(LIGHTWEIGHT_VARIANTS)  # e.g., 5
]
...
subset_cols = [c for c in ["model", "prompt", "source"] if c in combined.columns]
if subset_cols:
